...
exports.save = exports.initMongoDB = exports.getAll = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _mongoose["default"].connect(process.env.MONGO_ATLAS_URL);
        case 3:
          _logger["default"].info('Conectado a MongoDB');
          _context.next = 9;
          break;
        case 6:
          _context.prev = 6;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _user.UserModel.create(doc);
        case 3:
