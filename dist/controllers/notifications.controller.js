...
exports.wppController = exports.inboxController = exports.gmailController = void 0;
var _notifications = require("../services/notifications");
var _template = require("../services/template.js");
var _notifications2 = require("../services/notifications.js");
...
var gmailController = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var dest, mailOptions, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 2;
          _context.next = 5;
          return _notifications.transporter.sendMail(mailOptions);
        case 5:
  ...
  return function gmailController(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.gmailController = gmailController;
var wppController = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 4;
          return _notifications2.twilioClient.messages.create(message);
        case 4:
  ...
  return function wppController(_x3, _x4) {
...
var inboxController = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 5;
          return sendMessageToClient(req.body.WaId, "Hola ".concat(req.body.ProfileName, "!, \xBFCual es tu consulta?"));
        case 5:
          ...
          _context3.next = 8;
          return sendMessageToClient(req.body.WaId, "Chau ".concat(req.body.ProfileName, "!, \xA1Hasta pronto!"));
        case 8:
          _context3.next = 13;
          break;
        case 10:
  ...
  return function inboxController(_x5, _x6) {
